// ✅ גרסה מעודכנת מלאה: כולל שליחת created_by, בדיקות שדות חובה, טיפול ב-null, ועדכון תצוגה
...
export const useCreateAssignment = () => {
  ...
  return useMutation({
    ...
    onError: () => {
      toast({ title: 'שגיאה', description: 'לא ניתן להוסיף את העבודה', variant: 'destructive' });
    },
  });
};
...
export const useUpdateAssignment = () => {
  ...
  return useMutation({
    ...
    onError: () => {
      toast({ title: 'שגיאה', description: 'לא ניתן לעדכן את העבודה', variant: 'destructive' });
    },
  });
};
