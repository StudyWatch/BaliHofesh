...
const Index = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col overflow-x-hidden relative font-[Assistant] bg-transparent"
      dir={dir}
      lang={language}
    >
      {/* 🌈 רקע מונפש – גרדיאנט + 'blobs' צפים (לייט/דארק) */}
          ...
          <section className="pt-4 pb-2 md:py-14 bg-transparent min-h-[calc(100vh-168px)] flex flex-col justify-between">
            <div className="mx-auto px-2 flex flex-col items-center text-center flex-1 w-full max-w-[1320px]">
              ...
              {!isLoading && !isSearch && carouselCourses.length > 0 && (
                <>
                  <div className="w-full mt-1 mb-2 mx-auto flex items-center relative">
                        ...
                        >
                          ...
                          >
                            <CardHeader className="pb-2 pt-6 md:pt-4 px-5">
                              ...
                              {course.code && (
                                <Badge className="bg-blue-100 text-blue-800 dark:bg-pink-500/30 dark:text-pink-100 text-xs font-bold px-2 py-[2px] mt-1">
                                  {course.code}
                                </Badge>
                              )}
      ...
      <style>{`
        ...
        .bg-gradient{
          ...
          background: linear-gradient(120deg,
            #825ae8 0%, #a579e7 18%, #e8b5f5 38%, #fca4c0 56%, #f57bc5 75%, #7ecff2 100%);
        ...
        .blob1{ width:480px; height:480px; top:-120px; right:-80px;
          background: radial-gradient(circle at 30% 30%, #ff7ad1 0%, #8b5cf6 70%);
          animation: blobFloat1 26s ease-in-out infinite;
        }
        .blob2{ width:520px; height:520px; bottom:-160px; left:-120px;
          background: radial-gradient(circle at 70% 40%, #60a5fa 0%, #f472b6 65%);
          animation: blobFloat2 32s ease-in-out infinite;
        }
        .blob3{ width:360px; height:360px; top:42%; left:55%;
          background: radial-gradient(circle at 50% 50%, #fbbf24 0%, #fb7185 70%);
          animation: blobFloat3 30s ease-in-out infinite;
        }
        @keyframes blobFloat1 {
          0% { transform: translate(0,0) scale(1) rotate(0); }
          50% { transform: translate(-40px, 30px) scale(1.08) rotate(18deg); }
        ...
        @keyframes blobFloat3 {
          0% { transform: translate(0,0) scale(1) rotate(0); }
          50% { transform: translate(-30px,15px) scale(1.06) rotate(-12deg); }
          100% { transform: translate(0,0) scale(1) rotate(0); }
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          .animate-gradient-shift, .blob { animation: none !important; }
        }
        ...
        .sticky-search-active {
          position: sticky !important; top: 56px; background: rgba(245,245,255,0.92);
          box-shadow: 0 3px 12px 0 rgba(185,110,255,0.07); border-radius: 1rem;
        }
        ...
        .carousel-arrow{
          ...
          background:rgba(255,255,255,0.88); color:#1e3a8a;
          border:1px solid rgba(255,255,255,0.6); border-radius:9999px;
          width:44px; height:44px; box-shadow:0 6px 16px rgba(0,0,0,0.12);
        }
        .carousel-arrow:hover{ transform:translateY(-50%) scale(1.06); }
        @media (max-width: 767px){
          .carousel-arrow{ width:30px; height:30px; opacity:.45; background:rgba(255,255,255,.6); border:none; box-shadow:0 4px 10px rgba(0,0,0,.10); }
        }

        /* Mobile card width */
        @media (max-width: 767px){
          .keen-slider__slide > .card {
            min-width: 88vw !important; max-width: 94vw !important; margin-left:3vw; margin-right:3vw;
          }
          html, body, #root, .min-h-screen { min-height:100vh !important; height:100dvh !important; box-sizing:border-box; overscroll-behavior:none; }
        ...
        @media (max-width: 350px){ .keen-slider__slide > .card { min-width: 92vw !important; } }

        /* Popular badge */
        .popular-badge{
          position:absolute; left:.9rem; top:-10px;
          font-size:10px; line-height:1; padding:4px 8px; border-radius:9999px;
          background:linear-gradient(90deg,#ec4899,#8b5cf6); color:#fff; font-weight:800;
          box-shadow:0 10px 18px rgba(0,0,0,.18); border:1px solid rgba(255,255,255,.65);
          pointer-events:none;
        }
      `}</style>
    </div>
